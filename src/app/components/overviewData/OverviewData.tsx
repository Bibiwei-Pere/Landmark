...
import Video from "../../components/assets/images/video-play.svg";
import Gallery from "../../components/assets/images/gallery-add.svg";
import Add from "../../components/assets/images/add-button-red.svg";
				...
				<form onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="flex mt-4 w-[350px] mx-auto gap-[16px]">
						<Button variant={"secondary"}>
							<Link href="/dashboard/overview" className="flex justify-center items-center">
		...
		<div className="wrappers">
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="flex mt-4 w-[350px] mx-auto gap-[16px]">
						<Button variant={"secondary"}>
							<Link href="/dashboard/overview/shop" className="flex justify-center items-center">
								<ArrowLeftCircleIcon className="mr-2 h-4 w-4" />
								Back
							</Link>
						</Button>
		...
		<div className="wrappers">
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)}>
					...
					<div className="flex mt-4 w-[350px] mx-auto gap-[16px]">
						<Button variant={"secondary"}>
							<Link href="/dashboard/overview/verification" className="flex justify-center items-center">
								<ArrowLeftCircleIcon className="mr-2 h-4 w-4" />
								Back
							</Link>
						</Button>
