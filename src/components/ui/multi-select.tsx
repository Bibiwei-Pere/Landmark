	...
	return (
		<Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
			<PopoverTrigger asChild>
				<Button ref={ref} {...props} onClick={handleTogglePopover} className={cn("flex max-w-full p-1 rounded-lg border min-h-12 h-auto items-center justify-between bg-inherit hover:bg-inherit", className)}>
						...
						<div className="flex justify-between items-center w-full">
							<div className="flex flex-wrap items-center">
								{selectedValues.slice(0, maxCount).map((value) => {
									...
									return (
										<Badge key={value} className={cn("bg-red-50 text-red-700 border-foreground/1 hover:bg-transparent", isAnimating ? "animate-bounce" : "", multiSelectVariants({ variant, className }))} style={{ animationDuration: `${animation}s` }}>
								...
								{selectedValues.length > maxCount && (
									<Badge className={cn("bg-transparent text-red-700 border-foreground/1 hover:bg-transparent", isAnimating ? "animate-bounce" : "", multiSelectVariants({ variant, className }))} style={{ animationDuration: `${animation}s` }}>
